...
--Global numbers
Select date, SUM(total_cases) as TotalCases, SUM(cast(new_deaths as int)) as TotalDeaths, SUM(cast(new_deaths as int))/SUM(new_cases)*100 as Death_percentage --total_deaths, (total_deaths/total_cases)*100 as Death_Percentage
From PORTFOLIO..CovidDeaths
Where continent is not null
Group by date
order by 1,2
